...
<html>
    ...
    <body>
        <div id="logo_text">
            ...
            <h1><a href="#"><font color="white">Miracle Supply Chain Visibility Portal</font></a>
            ...
            <h2>
                ...
                <font color="white"><s:property value="#session.tpoLoginId" /></font>
                </s:if>
                <s:else>
            ...
            <h2>
             ...
             <h2>
                <s:if test="#session.tpoLoginId != null">
                <a href="<s:url value="../general/tpoLogout"/>"> 
